...
const Rooms = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative h-[600px] bg-gray-300 flex items-center justify-center overflow-hidden">
      ...
      {/* Elevate Your Suite Stay Section */}
      <section className="relative h-[800px] bg-blue-900 overflow-hidden">
        <div className="absolute inset-0 bg-blue-900/50"></div>
        <div className="absolute inset-0 shadow-[inset_0_0_144px_72px_rgba(0,0,0,0.35)]"></div>

        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center text-white px-4">
          <h2
            className="text-xl md:text-2xl font-normal uppercase tracking-[2px] mb-4"
            style={{ fontFamily: "Proxima Nova, sans-serif" }}
          >
            AWE INSPIRING ACCOMMODATIONS
          </h2>
          <h1
            className="text-3xl md:text-4xl lg:text-6xl font-normal uppercase leading-tight mb-8"
            style={{ fontFamily: "Kapra Neue Pro, sans-serif" }}
          >
            ELEVATE YOUR SUITE STAY
          </h1>
          <p
            className="text-xl md:text-2xl max-w-5xl mx-auto leading-relaxed mb-16"
            style={{ fontFamily: "Proxima Nova, sans-serif" }}
          >
            Customized adventures, exclusive access and inclusive amenities.
            Luxury cruise suite accommodations on Royal Caribbean elevate every
            aspect of your adventure. From full-size tubs in Junior suites to
            24-hour room service in Owner Suites and dedicated check-in for
            Royal Suite class, it's little details you'd expect — plus elevated
            experiences you may have never imagined.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div className="text-left">
              <div className="h-80 bg-gray-300 rounded-lg mb-6"></div>
              <h3
                className="text-xl font-bold uppercase tracking-[2px] mb-4"
                style={{ fontFamily: "Proxima Nova, sans-serif" }}
              >
                THE SUITE LIFE
              </h3>
              <p
                ...
                style={{ fontFamily: "Proxima Nova, sans-serif" }}
              >
                Level up your vacation with a spacious suite. Choose between an
                intimate Junior Suite with great views, or a Grand Suite
                featuring a bedroom, living area and private balcony. And if
                you're looking for the ultimate suite to complement an
                unforgettable adventure, opt for the Owners Suite loaded with
                extra added perks.
              </p>
            </div>
            ...
            <div className="text-left">
              ...
              <p
                ...
                style={{ fontFamily: "Proxima Nova, sans-serif" }}
              >
                In Royal Suite Class — available on Oasis Class and select
                Quantum Class ships —every detail is thought of, so you won't
                have to lift a finger. Sea, Sky and Star tiers include perks
                that range from exclusive spaces and venues to a Royal Genie or
                Concierge who will craft VIP experiences just for you — and
                more.
              </p>
            </div>
            ...
            <div className="text-left">
              ...
              >
                ...
                to enjoy the thrills. Kids have their own in-suite slides and
                private game room. Plus there's plenty of perks for parents too,
                like a private balcony jacuzzi. And our biggest suite ever, the
                Ultimate Family Townhouse on Icon of the Seas℠ maxes memories
                across three levels.
              </p>
            </div>
          </div>
